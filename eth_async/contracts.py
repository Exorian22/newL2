...
class Contracts:
    ...
    async def get_abi(self, contract_address: types.Contract):
        headers =  {'content-type': 'application/json', 'user-agent': UserAgent().chrome}

        url = f'https://api-era.zksync.network/api?module=contract&action=getabi&address={contract_address}&apikey=61IB5HKDDUAQK5CCRSQ17NP4E68GP9GFS8'
